...
class _UploadImagePageState extends State<UploadImagePage> {
  ...
  _actionsPopupMenu(String item){
    print("teste");
  }

  _chooseGaleryImage() async{
    ...
    return Scaffold(
          ...
          child: AppBar(
            ...
            actions: <Widget> [
              PopupMenuButton<String>(
                ...
                icon: Icon(Icons.menu, color: Color(0xffBA68C8), size: 40,),
                  ...
                  child: Column(
                    children: [
                      ...
                      Container(
                        ...
                        margin: EdgeInsets.fromLTRB(32, 18, 18, 5),
      ...
      floatingActionButton:
        FloatingActionButton(
          ...
          child: const Icon(Icons.arrow_forward_ios, color: Color(0xffFFFFFF)),
